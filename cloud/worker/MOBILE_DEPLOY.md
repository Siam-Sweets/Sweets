...
4. Test `<worker-url>/v1/health`; it should return `ok: true` and version `1.9.8`.
...
- Do not add `ACTIONS_ALLOW_USE_UNSECURE_NODE_VERSION`; v1.9.8 no longer depends on Node.js 20.
