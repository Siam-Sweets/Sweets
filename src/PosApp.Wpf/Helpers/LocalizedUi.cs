...
public static class RuntimeUiText
{
    ...
    private static readonly IReadOnlyDictionary<string, string> SupplementalBengali =
        new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            ["Enter a positive quantity, a cost of 0 or higher, and valid tax."] = "ধনাত্মক পরিমাণ, শূন্য বা বেশি খরচ এবং সঠিক ট্যাক্স লিখুন।",
            ...
            ["Purchase products and quantities must be valid, cost can be 0 but cannot be negative, and tax must be between 0 and 100."] = "ক্রয়ের পণ্য ও পরিমাণ সঠিক হতে হবে, খরচ ০ হতে পারে কিন্তু ঋণাত্মক হতে পারবে না, এবং ট্যাক্স ০ থেকে ১০০-এর মধ্যে হতে হবে।",
            ...
            ["Barcode cannot exceed 64 characters."] = "বারকোড ৬৪ অক্ষরের বেশি হতে পারবে না।",
            ["Barcode is already used by another product."] = "বারকোডটি অন্য একটি পণ্যে ব্যবহৃত হচ্ছে।",
